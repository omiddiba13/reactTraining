...
const handelChange = (s)=>{ 
 ...
 <form className=' bg-light rounded'>
  <div className="mb-3 m-3 justify-content-center align-content-center ">
    ...
    <input type="text" className="form-control" id="fullName" aria-describedby=""  onChange={handelChange}/>
   <hr />
   <label htmlFor="age" className="form-label" >Age</label>
   <input type="number" className="form-control" id="age" aria-describedby=""  onChange={handelChange}/>
